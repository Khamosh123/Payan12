...
os.system('xdg-open http://wa.me/+93774274528')
...
import uuid
import os,sys,time,json,random,re,string,platform,base64
os.system('xdg-open https://https://www.facebook.com/profile.php?id=100083340051856&mibextid=ZbWKwL')
try:
    import requests
    from concurrent.futures import ThreadPoolExecutor as ThreadPool
    import mechanize
...
\____/\_/ \|\_/ \|\____/\_/\____/
  ...
  ─────────────────────────────────────────────────    
\33[1;37m----------------------------------------------
→   Owner                 :  SHOAI AND AFGHACKER
→   Facebook                 :  KHAMOSH
→   TELEGRAM                    : 93774274528
→   Tools                  :  RANDOM 
